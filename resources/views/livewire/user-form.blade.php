            ...
            <form wire:submit.prevent="save" class="space-y-6">
                <div>
                    ...
                    <input wire:model="name" 
                           type="text"
                           class="w-full mt-1 p-2 bg-gray-100 rounded focus:outline-none"
                ...
                <button type="submit" 
                        class="w-full bg-purple-600 text-white p-2 rounded hover:bg-purple-700 transition duration-200">
                    Criar Conta
                </button>
            </form>
